...
class OriginalCGO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Chaos Game Optimization", year=2021, difficulty="easy", kind="original",
                       scientific_status="questionable",
                       concerns=(
                           ScientificConcern.AMBIGUOUS_METHODOLOGY, ScientificConcern.QUESTIONABLE_MATH
                       ))
