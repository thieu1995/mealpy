...
class DevFBIO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Forensic-Based Investigation Optimization (Dev)", difficulty="medium", kind="developed")
...
class OriginalFBIO(DevFBIO):
    ...
    OPT_INFO = OptInfo(name="Forensic-Based Investigation Optimization", year=2020, difficulty="medium", kind="original")
