...
class OriginalWarSO(Optimizer):
    ...
    rr : float
        The probability of switching position updating, in range (0.0, 1.0). Default is 0.1.

    References
    ~~~~~~~~~~
    1. Ayyarao, Tummala SLV, and Polamarasetty P. Kumar. "Parameter estimation of solar PV models with a new
       proposed war strategy optimization algorithm." International Journal of Energy Research (2022).
    ...
    OPT_INFO = OptInfo(name="War Strategy Optimization", year=2022, difficulty="easy", kind="original")
