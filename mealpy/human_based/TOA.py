...
class OriginalTOA(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Teamwork Optimization Algorithm", year=2021, difficulty="easy", kind="original",
                       scientific_status="under_investigation",
                       concerns=(
                           ScientificConcern.LACK_OF_NOVELTY, ScientificConcern.RESEARCH_MISCONDUCT,
                           ScientificConcern.FABRICATED_RESULTS, ScientificConcern.SUSPECTED_SELF_PLAGIARISM
                       ))
