...
class DevGSKA(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Gaining Sharing Knowledge-based Algorithm (Dev)", difficulty="medium", kind="developed")
...
class OriginalGSKA(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Gaining Sharing Knowledge-based Algorithm", year=2020, difficulty="medium", kind="original")
