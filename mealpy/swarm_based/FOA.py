...
class OriginalFOA(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Fruit-fly Optimization Algorithm", year=2012, difficulty="easy", kind="original")
...
class DevFOA(OriginalFOA):
    ...
    OPT_INFO = OptInfo(name="Fruit-fly Optimization Algorithm (Dev)", difficulty="easy", kind="developed")
...
class WhaleFOA(OriginalFOA):
    ...
    OPT_INFO = OptInfo(name="Whale Fruit-fly Optimization Algorithm ", year=2020, difficulty="easy", kind="developed")
