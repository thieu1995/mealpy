...
class OriginalSeaHO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Sea-Horse Optimization", year=2022, difficulty="medium", kind="original")
    ...
    def evolve(self, epoch):
        ...
        pop_child, _ = self.get_sorted_population(pop_child, self.problem.minmax)         # Sorted population
