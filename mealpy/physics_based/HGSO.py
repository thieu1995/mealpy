...
class OriginalHGSO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Henry Gas Solubility Optimization", year=2019, difficulty="hard", kind="original")
    ...
    def get_best_solution_in_team__(self, group=None):
        ...
        for idx in range(len(group)):
            best_agent, _ = self.get_best_agent(group[idx], self.problem.minmax)
