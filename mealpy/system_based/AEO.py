...
class OriginalAEO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Artificial Ecosystem-based Optimization", year=2020, difficulty="medium", kind="original")
...
class ImprovedAEO(OriginalAEO):
    ...
    OPT_INFO = OptInfo(name="Improved Artificial Ecosystem-based Optimization", year=2021, difficulty="medium", kind="variant")
...
class EnhancedAEO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Enhanced Artificial Ecosystem-Based Optimization", year=2020, difficulty="medium", kind="variant")
...
class ModifiedAEO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Modified Artificial Ecosystem-Based Optimization", year=2020, difficulty="medium", kind="variant")
...
class AugmentedAEO(Optimizer):
    ...
    OPT_INFO = OptInfo(name="Augmented Artificial Ecosystem Optimization", year=2022, difficulty="medium", kind="variant")
