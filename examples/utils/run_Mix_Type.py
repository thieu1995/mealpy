...
# bounds = [
#     IntegerVar(n_vars=3, lb=(-10, -15, -4), ub=(5, 7, 2), name="Pc"),
#     StringVar(n_vars=2, valid_sets=(("auto", "adaptive", "modified"),
#                                     (0.01, 0.1, "auto", 0.05, "curve")), name="alpha"),
#     IntegerVar(n_vars=2, lb=(0, 0), ub=(11, 15), name="Ld")
# ]
...
#     StringVar(n_vars=2, valid_sets=(("auto", "adaptive", "modified"),
#                                     (0.01, 0.1, "auto", 0.05, "curve")), name="alpha"),
#     FloatVar(n_vars=3, lb=(1.5, -5.5, -4.0), ub=(15.5, 7.5, 2.5), name="Pc"),
#     FloatVar(n_vars=2, lb=(0.5, 0.2), ub=(18.0, 20.2), name="Ld")
# ]
...
# bounds = [
#     FloatVar(n_vars=2, lb=(0.5, 0.2), ub=(18.0, 20.2), name="Lx"),
#     IntegerVar(n_vars=2, lb=(0, 0), ub=(11, 15), name="Ld"),
#     StringVar(n_vars=2, valid_sets=(("auto", "adaptive", "modified"),
#                                     (0.01, 0.1, "auto", 0.05, "curve")), name="alpha"),
#     FloatVar(n_vars=3, lb=(1.5, -5.5, -4.0), ub=(15.5, 7.5, 2.5), name="Pc"),
#     PermutationVar(n_vars=5, valid_set=(9, 4, 6, 2, 0), name="beta")
# ]
