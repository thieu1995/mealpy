...
To explore the complete, up-to-date registry of supported optimizers and their categorical breakdown, 
please check out our [Official Classification Table](https://mealpy.readthedocs.io/en/latest/pages/support.html#classification-table) 
or consult the foundational [research paper](https://doi.org/10.1016/j.procs.2020.09.075).
...
if __name__ == "__main__":
    ...
    model = SSpiderA.DevSSpiderA(epoch=100, pop_size=50, r_a=1.0, p_c=0.7, p_m=0.1)
...
* **SSpiderA - Social Spider Algorithm** 
  * **DevSSpiderA**: James, J. Q., & Li, V. O. (2015). A social spider algorithm for global optimization. Applied Soft Computing, 30, 614-627.
