...
But there are different stopping condition you can try by creating an Termination object. There are 4 termination cases:
...
.. code-block:: python
   ...
   term_obj1 = Termination(term_dict1)
...
.. code-block:: python
   ...
   term_obj2 = Termination(term_dict2)
...
.. code-block:: python
   ...
   term_obj3 = Termination(term_dict3)
...
.. code-block:: python
   ...
   term_obj4 = Termination(term_dict4)
...
.. code-block:: python
   ...
   model3 = SMA.BaseSMA(problem_dict1, epoch=100, pop_size=50, pr=0.03, termination=term_obj4)
   model3.solve()
